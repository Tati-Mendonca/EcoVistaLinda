    ...
    <section className="w-full min-h-[calc(100vh)] grid grid-cols-1 md:grid-cols-2">
      ...
      <aside className="bg-dark flex flex-col justify-center px-8 py-23 sm:px-16 lg:px-24 text-neutral">
        <div className="max-w-md mx-auto md:mx-0">
          ...
          <p className="text-neutral text-base sm:text-lg mb-10 leading-relaxed font-medium">
            Uma plataforma para moradores da rua Belo Jardim em Pirituba/SP com
            o objetivo de facilitar o acesso a informações a respeito dos dias e
            horários da coleta seletiva, incentivar a reciclagem e reduzir o
